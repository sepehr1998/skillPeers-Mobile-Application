...
class AddExperienceModal extends Component {
  ...
  addNewExperience() {
    ...
    if (this.isEmpty(this.state.workplace)) {
      this.setState({ errorText: "workplace is required" });
      return;
    }
    ...
    let newExperiment = {
      end: this.state.endDate + "T14:09:53.162Z",
      start: this.state.startDate + "T14:09:53.162Z",
      workplace: this.state.workplace,
    };
    this.props.addExperience(newExperiment);
  }
      ...
      <Provider>
        <Portal>
          ...
          >
            ...
            >
              <TouchableOpacity
                style={[styles.buttonContainer, styles.experienceButton]}
                onPress={() => {
                  this.addNewExperience();
                }}
                disabled={this.state.loading}
              >
                <Text style={styles.experienceText}>Add</Text>
              </TouchableOpacity>
            </View>
          </Modal>
        </Portal>
