...
const data = [
  ...
  },
  {
    ...
    text:
      "Whatever you do, it doesn't matter how skilled you are. It's all about what those skills can satisfy the client",
...
export default class ProslinkSlider extends React.Component {
  ...
  getData = async () => {
    ...
    try {
      ...
      if (value !== null) {
        ...
        //alert(value)
        if (value == "varse") this.setState({ showRealApp: true });
      }
    } catch (e) {
      // error reading value
    }
  ...
  Done() {
    ...
    this.props.navigation.replace("Home", { initialState: "Home" }); //Home
  }
